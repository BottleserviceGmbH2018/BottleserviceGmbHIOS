...
enum Language: String {
    ...
    static var language: Language {
        ...
        //    UIApplication.shared.windows[0].rootViewController = UIStoryboard(name:"Login", bundle: nil).instantiateInitialViewController()

       //     let vc = UIStoryboard(name: "Login", bundle: nil).instantiateInitialViewController() as! Login
